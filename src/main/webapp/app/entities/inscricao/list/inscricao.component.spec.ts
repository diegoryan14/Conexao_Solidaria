...
import { sampleWithRequiredData } from '../inscricao.test-samples';
...
describe('Inscricao Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, InscricaoComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.inscricaos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to inscricaoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getInscricaoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getInscricaoIdentifier).toHaveBeenCalledWith(entity);
