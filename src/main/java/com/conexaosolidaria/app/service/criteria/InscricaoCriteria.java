...
/**
 * Criteria class for the {@link com.conexaosolidaria.app.domain.Inscricao} entity. This class is used
 * in {@link com.conexaosolidaria.app.web.rest.InscricaoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /inscricaos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InscricaoCriteria implements Serializable, Criteria {
    ...
    public InscricaoCriteria() {}

    public InscricaoCriteria(InscricaoCriteria other) {
    ...
    @Override
    public InscricaoCriteria copy() {
        return new InscricaoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InscricaoCriteria that = (InscricaoCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, data, userId, eventoId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "InscricaoCriteria{" +
